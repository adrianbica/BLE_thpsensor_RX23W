...
#define _3E_PDR2_DEFAULT        (0x3EU) /* PDR2 default value */
#define _1D_PDR4_DEFAULT        (0x1DU) /* PDR4 default value */
#define _7C_PDRB_DEFAULT        (0x7CU) /* PDRB default value */
#define _02_PDRC_DEFAULT        (0x02U) /* PDRC default value */
#define _F7_PDRD_DEFAULT        (0xF7U) /* PDRD default value */
#define _E3_PDRE_DEFAULT        (0xE3U) /* PDRE default value */
